  ...
  return (
    <section id="main" className="lp-section" style={{ paddingTop: "clamp(3rem, 6vw, 6rem)" }}>
      <div className="lp-container lp-hero-grid">
        <div>
          <p className="lp-eyebrow">Static analysis for Pull Requests</p>
          <h1 className="lp-display" style={{ marginTop: "1.5rem" }}>
            Catch code smells before they <em style={{ fontStyle: "italic" }}>merge.</em>
          </h1>
          <p className="lp-lead" style={{ marginTop: "1.75rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", margin: "2rem 0" }} aria-hidden="true">
